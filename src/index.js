...
function insertBreeds(breeds){
    ...
    filteredBreeds.map(function(breed){
        ...
        li.addEventListener('mouseout', backToOriginalColor)
        ul.appendChild(li)
    })

    // This functions targets the element on which the event is being triggered
    function changeColor(e){
        e.target.style.color = "magenta";
    }

    function backToOriginalColor(e){
